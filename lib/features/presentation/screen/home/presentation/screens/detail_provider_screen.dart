...
import 'package:country_picker/country_picker.dart';
  class DetailsProviderScreen extends AppStatefulWidget {
  ProviderEntity providerEntity;

  DetailsProviderScreen({ required this.providerEntity,Key? key});

  @override
  State<StatefulWidget> createState() => _DetailsProviderScreenState();
}

class _DetailsProviderScreenState extends StatefulWidgetState<DetailsProviderScreen> {
  @override
  initState() {
 ...
 child:     Column(
   ...
   Container(
     ...
     return
       CountryRateCard(countrysRatesModel: moneystate.countryList[index],
       providerId:widget.providerEntity.providerId??"");
     },
     separatorBuilder: (BuildContext context, index) =>
     CommonSizes.vCustomSpace(28.h),
     itemCount: moneystate.countryList.length);
  ...
  Future<void> showCustomMessage ({
    ...
    String dest="choose destination";
                ...
                if(source.compareTo("choose source")==0){
                 Utils.showToast("choose source");
                  ...
                  Utils.showToast("choose destination");
                   ...
                   BlocProvider.of<MoneyProviderCubit>(context)
                       .addCountryRateProvider(
                       subCollectionId:widget.providerEntity.providerId??"",countrysRatesModel:
      ...
      builder: (context) =>
          ...
          StatefulBuilder(builder: (stcontext, stfSetState) {
            ...
            listener:(BuildContext context,MoneyProviderState moneyState) {
               ...
               if (moneyState is AddCountryRateLoaded){
                 Navigator.of(context).pop();
               }
            },
